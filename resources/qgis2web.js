...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3844',
            //extent: [431215.236700, 475408.991400, 432100.002000, 476361.244045],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([430798.183896, 475379.969816, 432370.246956, 476379.835094], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_TerenurideinteresCampsor_1,
    colName: 'CF sau TP',
    zoom: 10,
    collapsed: true,
    map: map,
